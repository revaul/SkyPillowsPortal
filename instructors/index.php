...
<body>
    <?php require '/instructors/namevariables.php';
            ...
            <div class="col-sm-6">
                <div class="sub_box">
                    <div class="link_button">
                        ...
                        <p>
                            <?php echo $s1n; ?> is no stranger to iD Tech; previously
                            <?php echo $s1n; ?> has not only taught at iD Tech before but he also attended iD Tech as a student. Currently,
            ...
            <div class="col-sm-6">
                <div class="sub_box">
                    ...
                    <div class="link_button">
                        ...
                        <h3 class="instructor_title">Instructor</h3>
                        <p>
                            <?php echo $s4n; ?> is excited to return to iD Tech Camps and as Instructor for a second year!
            ...
            <div class="col-sm-6">
                <div class="sub_box">
                    ...
                    <div class="link_button">
                        ...
                        <h3 class="instructor_title">Instructor</h3>
                        <p>
                            <?php echo $s6n; ?> is no stranger to camp life, having spent two summers in high school leading a group of 10-13 campers around to their various activities;
                            <?php echo $s6n; ?> understands what it means to keep kids safe while having the most fun possible.
